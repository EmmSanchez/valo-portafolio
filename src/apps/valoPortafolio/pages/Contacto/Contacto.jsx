...
export default function Contacto() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await submitContactForm("valo", data);
      form.reset();
        ...
        >
          ...
          <div className="absolute z-10 bottom-0 right-0 default-padding">
            <button
              ...
              className="group flex w-[clamp(180px,16.2vw,311px)] h-[clamp(38px,3.65vw,70px)] justify-between items-center px-[29px] 2xl:px-11.25 bg-valo hover:bg-white hover:cursor-pointer -translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
            >
