          ...
          <div className="overflow-hidden w-full h-full" ref={emblaRef}>
            <div className="flex h-full">
              {LOCALES_DISPONIBLES.map((slide) => (
                <div
                  key={slide.id}
                  className="flex-[0_0_100%] min-w-0 h-full flex flex-col items-center justify-center px-[4vw] gap-[2vh] lg:gap-[clamp(11.81px,2.083333vw,40px)]"
                >
                  {/* Título del slide */}
                  <div className="flex flex-col text-center lg:gap-[clamp(5.91px,1.041667vw,20px)]">
                    <h2 className="text-foro4-verde font-lumarc font-bold uppercase tracking-wide text-mobile-title-lg lg:text-title-lg">
                      Locales Disponibles — {slide.piso}
                    </h2>
                    <p className="text-white text-mobile-title-md lg:text-paragraph">
                      {slide.descripcion}
                    </p>
                  </div>
          ...
          <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-[clamp(8.56px,1.510417vw,29px)] pointer-events-auto">
            ...
            >
              <svg
                ...
                viewBox="0 0 19 34"
                fill="none"
                className="w-[clamp(4.4px,1.374vw,10px)] lg:w-[clamp(8.4px,2.61vw,19px)]"
              >
                <path
