...
export default function RotationMessageForo4() {
  return (
    <div className="flex flex-col w-full h-dvh p-[clamp(18.5px,3.255208vw,25px)] bg-foro4-morado/85 backdrop-blur-xs">
      <div className="flex flex-col shrink-0">
        {/* Botón cerrar */}
        <button className="self-end w-fit h-fit p-[clamp(5.02px,0.885417vw,17px)] hover:cursor-pointer bg-white">
          <CerrarIcon className="size-[clamp(13.31px,2.34375vw,45px)] text-foro4-morado" />
        </button>
        <img
          src={logo}
          alt="Logo Principal Foro 4"
          className="self-center w-[clamp(110.26px,19.401042vw,149px)] h-[clamp(31.08px,5.46875vw,42px)] text-valo"
        />
      </div>
      ...
      <div className="flex shrink-0 self-center gap-[clamp(11.83px,2.083333vw,16px)]">
        <SocialIcon
          icon={Whatsapp}
          href={"#"}
          className="text-foro4-morado group-hover:text-white"
          bgColor="bg-white"
          hoverBgColor="hover:bg-foro4-morado"
        />
        <SocialIcon
          icon={Web}
          href={"#"}
