        ...
        {menu.map((section) => {
          return (
            <Link
              key={section.id}
              to={section.to}
              className="group flex items-center justify-between w-full h-[clamp(32px,3.65vw,70px)] px-6.25 text-paragraph-button font-semibold rounded-[40px] hover:bg-foro4-morado hover:font-bold hover:cursor-pointer"
            >
